...
def replace_locations(sessionID:int, RXfile:str, TXfile:str, dir:str, datInfo=[]):
    ...
    try: 
        ...
        print('Unable to load in rx or tx file')
        ...
        try:
            ...
            print('Unable to replace GPS location with rx or tx location')
...
def polarity_correction(dir:str):
    ...
    try:
        ...
        print('Unable to load in data file')
        ...
        try:
            ...
            for n in range(0,17): # number of header option; takes too long to check all
                ...
                if cfstr in teststr:
                    ...
                    if '-' in addto[1]:
                        raise Exception('Polarity of conversion factor is already negative')
                    else:
            ...
            print('Unable to change conversion factor polarity, may already be neg')
...
def update_resistivity(fIn:str):
    ...
    try:
        ...
        print('Could not properly read in file, check file formatting')
        ...
        try: 
            ...
            if res <= 0:
                raise Exception('Unrealistic resistivity')

        except:
            f.attrs['dc_qc'] = 'reject'
            f.attrs['ip_qc'] = 'reject'
            print('Resistivity calculation failed, dc_qc and ip_qc rejected')
...
def stretched_exponential_decay_fit(fIn:str):
    ...
    try: 
        ...
        print('Could not properly read in file or extract values, check file formatting')
        ...
        try:
            ...
            if 1 in popt: # a, b, c will == 1 if it didn't work
                f.attrs['ip_qc'] = 'reject' 
                raise Exception('Decay fit could not accurately fit data')
        
        except:
            print('Curve_fit function could not fit data')
            ...
            try:
                ...
                if std > 0.1: # TODO is this too high/low?
                    f.attrs['ip_qc'] = 'reject' 
                else:
                ...
                print('Decay function produced an intangible value')
